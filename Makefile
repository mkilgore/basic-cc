...
$(eval $(call proj_inc,src))
CLEAN_LIST += $(objtree)/bin

EXES := $(objtree)/bin/basic-cc
...
install:
	$(Q)mkdir -p $(BINDIR)
	@echo " INSTALL basic-cc"
	$(Q)install -m 775 ./bin/basic-cc $(BINDIR)
	@echo " basic-cc Installation done"
